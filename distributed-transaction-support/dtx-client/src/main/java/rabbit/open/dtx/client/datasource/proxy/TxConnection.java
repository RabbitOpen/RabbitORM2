...
public class TxConnection implements Connection {
    ...
    public PreparedStatement prepareStatement(String sql) throws SQLException {
        ...
        this.currentSql = sql;
        return getTxPreparedStatement(realStmt);
    }
     ...
     * @date    2019/12/3
     **/
    private TxPreparedStatement getTxPreparedStatement(PreparedStatement realStmt) {
        return new TxPreparedStatement(realStmt, this);
    }
    ...
    public PreparedStatement prepareStatement(String sql, int resultSetType, int resultSetConcurrency) throws SQLException {
        ...
        this.currentSql = sql;
        return getTxPreparedStatement(statement);
    }
