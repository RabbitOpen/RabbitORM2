 ...
 * @date 2019/12/3
 **/
public abstract class AbstractAnnotationEnhancer extends AbstractAutoProxyCreator {

    private Set<String> beans2Enhance = new HashSet<>();

    private Object[] pointCuts;

    // 获取目标注解
    protected abstract Class<? extends Annotation> getTargetAnnotation();

    // 获取切面处理器
    protected abstract PointCutHandler getHandler();
