...
public class MultiFetchTest {
    ...
    public void repeatedFetchExceptionTest(){
        try{
            ts.createQuery().fetch(Organization.class, User.class).fetch(Organization.class).execute();
            throw new RuntimeException();
        }catch(Exception e){
            TestCase.assertEquals(e.getClass(), RepeatedFetchOperationException.class);
        }
    }
    ...
    public void multiFetchWithFilterTest(){
        ...
        Team team = ts.createQuery().addFilter("id", t.getId())
                    ...
                    .joinFetch(Car.class, cars.get(0))
                    .execute().unique();
    ...
    public void ambiguousDependencyExceptionTest(){
        ...
        try{
            ts.createQuery().addFilter("id", t.getId())
                .buildFetch().fetch(User.class).fetch(Organization.class).build()
                .execute().unique();
            throw new RuntimeException();
        }catch(Exception e){
            TestCase.assertEquals(e.getClass(), AmbiguousDependencyException.class);
