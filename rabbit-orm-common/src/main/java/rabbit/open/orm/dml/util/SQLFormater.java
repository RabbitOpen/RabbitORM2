package rabbit.open.orm.dml.util;
...
public class SQLFormater {
	...
	private static class FormatProcess {
		...
		private static boolean isFunctionName(String tok) {
			...
			return (isIdentifier) && (!SQLFormater.LOGICAL.contains(tok))
					&& (!SQLFormater.END_CLAUSES.contains(tok))
					&& (!SQLFormater.QUANTIFIERS.contains(tok)) && (!SQLFormater.DML.contains(tok))
					&& (!SQLFormater.MISC.contains(tok));
		}
