...
public @interface Entity {
	...
	// 分表策略实现
	public Class<? extends ShardingPolicy> shardingPolicy() default DefaultShardingPolicy.class;

	// 设置关心的字段，用于查询过滤
	public String[] concern() default {};

	// 分片表分页策略
	public PagePolicy pagePolicy() default PagePolicy.DEFAULT;
	
	// 分页排序字段名称
	public String orderIndexFieldName() default "";
}
